...
describe('CreateUserRequest', () => {
  it('should define the properties: FirstName, LastName, Username, Password, AuthToken, UserRole, AssociationId and set them on init', () => {
    let request = new CreateUserRequest('John', 'Doe', 'john.doe', 'Password1!', 'a1b2c3', Entity.UserRole.USER, 1);
